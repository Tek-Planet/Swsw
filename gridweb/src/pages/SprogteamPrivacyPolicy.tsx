  ...
  const sections = [
    {
      ...
      content: [
        ...
        "Event attendance: tickets purchased and events attended through Sprogteam",
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        >
          ...
          <div className="mb-12">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">Sprogteam Privacy Policy</h1>
          ...
          <div className="glass rounded-2xl p-6 md:p-8 mb-8">
            <p className="text-foreground/90 leading-relaxed">
              At Sprogteam, we take your privacy seriously. This policy explains how we collect, 
              use, and protect your personal information when you use our platform. By using 
              Sprogteam, you agree to the collection and use of information in accordance with 
              this policy.
            </p>
          </div>
          ...
          >
            ...
            <a 
              href="mailto:privacy@sprogteam.com" 
              className="text-primary hover:underline"
            >
              privacy@sprogteam.com
            </a>
          </motion.div>
        </motion.div>
      </main>
      ...
      <footer className="border-t border-border py-8 mt-16">
        <div className="container mx-auto px-4 text-center text-muted-foreground text-sm">
          © 2024 Sprogteam. All rights reserved.
        </div>
      </footer>
    </div>
  );
...
export default SprogteamPrivacyPolicy;
